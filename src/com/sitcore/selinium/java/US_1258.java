...
public class US_1258 {
	...
	public void testMethod() throws Exception {
		...
		ObjectRepositoryMain.launchChromeWithSpecificURL("https://sitecore--finaluat.lightning.force.com/lightning/n/Forecast_Leader");
		ObjectRepositoryMain.loginUser_SalesOps();
		Assert.assertEquals("Public Sector", ObjectRepositoryMain.verifyLeaderShipForecast_RegionField());
		Assert.assertEquals("Americas", ObjectRepositoryMain.verifyLeaderShipForecast_AreaField());
		ObjectRepositoryMain.closeChrome();
	}
